...
export function repeated(decoder: decoding.Decoder, decoderFunction: DecoderFunction): any[] {
	const outputList = []
	const iterableInput = new decoding.Decoder(decoding.readVarUint8Array(decoder))
