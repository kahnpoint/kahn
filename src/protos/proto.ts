...
import * as _proto from 'protobufjs/light'
 ...
 */
export const type = _proto.Type.d
 ...
 */
export const field = _proto.Field.d
 ...
 */
export const oneOf = _proto.OneOf.d

/**
 * OneOf.d<T extends string>(...fieldNames: string[])
	annotates a property as a protobuf oneof covering the specified fields.
*/
export const map = _proto.MapField.d
